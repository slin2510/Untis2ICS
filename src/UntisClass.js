...
export class Untis extends WebUntis{
    constructor(school, username, password, url, identity = 'Awesome', disableUserAgent = false){
        ...
        if(process.env.https_proxy!="" && process.env.https_proxy!=undefined){
            var httpsagent = new HttpsProxyAgent.HttpsProxyAgent(process.env.https_proxy)
